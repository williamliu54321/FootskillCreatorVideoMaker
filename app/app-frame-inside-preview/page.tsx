...
export default function AppFrameInsidePreview() {
  return (
    <div style={{
      background: '#000',
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <div style={{ width: 66, height: 28, border: '2px solid #fff', borderRadius: 6, position: 'relative', padding: 2 }}>
            <div style={{ background: '#fff', width: '85%', height: '100%', borderRadius: 3 }} />
            <div style={{ position: 'absolute', right: -6, top: 8, width: 4, height: 8, background: '#fff', borderRadius: 2 }} />
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ fontFamily: 'Orbitron, monospace', fontSize: 28, fontWeight: 700, letterSpacing: 2, color: '#fff' }}>
            {mm}:{ss}
          </span>
        </div>
      ...
      {/* VIDEO FRAME (rounded, shrunk — the INSIDE version) */}
      <div style={{
        position: 'absolute',
        ...
        <div style={{
          ...
          background: 'repeating-linear-gradient(45deg, rgba(255,255,255,0.03), rgba(255,255,255,0.03) 20px, transparent 20px, transparent 40px)',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          color: 'rgba(255,255,255,0.4)', fontSize: 32, fontWeight: 600, letterSpacing: 4,
        }}>
          [ BALL-TRAIL VIDEO ]
        </div>
        ...
        {[
          { top: 20, left: 20, borders: { borderTop: true, borderLeft: true } },
          { top: 20, right: 20, borders: { borderTop: true, borderRight: true } },
          { bottom: 20, left: 20, borders: { borderBottom: true, borderLeft: true } },
          { bottom: 20, right: 20, borders: { borderBottom: true, borderRight: true } },
        ].map((c, i) => (
          <div key={i} style={{
